...
const servicesData = [
    ...
    },
    {
        ...
        description: 'Юридическое сопровождение на всех этапах военной службы. Анализируем условия контракта, помогаем с досрочным расторжением, восстанавливаем на службе при незаконном увольнении, обжалуем приказы командования.',
    ...
    },
    {
        ...
        description: 'Взыскание задолженностей по зарплате, надбавкам, премиям. Перерасчет денежного довольствия, компенсации за задержку выплат, оформление подъемных и суточных. Защита финансовых прав военнослужащих.',
    ...
    },
    {
        ...
        description: 'Защита при служебных проверках и дисциплинарных взысканиях. Обжалование незаконных наказаний, представительство на заседаниях, подача жалоб в вышестоящие инстанции, восстановление репутации.',
    ...
    },
    {
        ...
        description: 'Полное сопровождение жилищных вопросов военнослужащих. Оформление субсидий, получение служебного жилья, включение в очередь, решение споров с наймодателями, взыскание компенсаций за наем.',
        icon: '<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><path d="M9 22V12h6v10" />',
        items: [
    ...
    },
    {
        ...
        description: 'Помощь при наступлении страховых случаев. Оформление требований при травмах и увечьях, взыскание страховых выплат, разрешение споров со страховыми компаниями, обжалование отказов в выплате.',
    ...
    },
    {
        ...
        description: 'Защита прав на льготы и социальное обеспечение. Оформление статуса участника СВО, получение компенсаций для семей, санаторно-курортное лечение, пенсионное обеспечение, льготы по налогам и ЖКХ.',
    ...
    },
    {
        ...
        description: 'Правовая поддержка при прохождении ВВЭ. Подготовка документов для военно-врачебной комиссии, обжалование заключений ВВК, установление категории годности, сопровождение при независимой экспертизе, оформление инвалидности.',
        ...
        <div class="flex-1">
          ...
          <details>
            <summary class="cursor-pointer text-accent text-sm font-semibold hover:text-accent-secondary transition">
              ${service.details ? 'Подробнее о услуге' : 'Что включаем'} →
            </summary>
...
// Инициализация услуг на странице
function initServices() {
    const container = document.getElementById('servicesContainer');
    if (!container) return;

    const servicesHTML = servicesData.map(service => {
        return service.featured ? createFeaturedCard(service) : createServiceCard(service);
    }).join('');
